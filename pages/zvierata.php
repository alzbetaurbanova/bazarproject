<?php
    ...
    if($_GET["hladaj"]) $sql = "SELECT * FROM zvierata WHERE NazovZ LIKE '%".$_GET["hladaj"]."%'";	//ak obsahuje hľadaný reťazec
	else $sql = "SELECT * FROM zvierata";
	$result = $conn->query($sql);
?>
<div class="row">
...
<div class="container">
    ...
    <tr>
      <td><div class="col-md-12">
                    <div class="card-body">
                        <h5 class="card-title"><b><?php echo $row["NazovZ"]; ?></b></h5>
                         <ul class="list-group list-group-flush">
                            <li class="list-group-item"><?php echo $row["PopisokZ"]; ?></li>
                            <li class="list-group-item"><?php echo $row["MestoZ"]; ?></li>
                            <li class="list-group-item"><a><?php echo $row["CenaZ"]; ?>€</a></li>
                        </ul>
   
                    </div>
      </td>
      <td><br><img src="Images/produkty/zvieratá/<?php echo $row["ObrazokZ"]; ?>"  style="max-width: 200px; max-height: 300px" alt="Foto"></td>
  </tbody>
 </table>
